...
(defun NLRI-zhash (octet-offset obj)
  (logxor (zhash-integer u24 octet-offset (NLRI-get-afisafi obj))
	  (zhash-integer u8 (+ 3 octet-offset) (NLRI-get-prefix-length-bits obj))
	  (zhash-list u56 (+ 4 octet-offset) (NLRI-get-prefix obj))))
